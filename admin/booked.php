	...
	<div id="content">
		<div class="post">
			...
			<div class="entry">
				<?php
						$count=1;
						$query="SELECT * FROM list where status='Booked'";
						...
						?>
							...
							<?php } ?>
						    <td>
						    <A class="tryitbtn" style="width:65px;padding-top:0px;padding-bottom:1px" href="update.php?c=b&d=a&b=<?php echo $row["id"]; ?>">Unbook</A>
						    	<A class="tryitbtn" style="width:65px;padding-top:0px;padding-bottom:1px" href="update.php?c=b&d=t&u=<?php echo $row["user_id"]; ?>&i=<?php echo $row["book"]; ?>&b=<?php echo $row["id"]; ?>">Taken</A></td>
			    			 </tr>
							<?php } ?>
   				</table>
			</div>
